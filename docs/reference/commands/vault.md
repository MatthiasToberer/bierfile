...
| `--init` | enter the passphrase on this Mac (the installer does this); `--init --stdin` takes it from standard input, checked against the safe — the bier tray asks this way |
