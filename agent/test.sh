...
"$agent" serve --agent mini --allowed-signers "$work/allowed_signers" --peer-signers "$work/peer_signers" --state-dir "$work/state" --port 53992 --bonjour false >"$work/agent.log" 2>&1 &
pid=$!
